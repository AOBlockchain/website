...
User.add(
	...
	'Investment Details',
	{
		...
		bchAddress: { type: String, label: 'BCH Send Address', noedit:true},
		investedBCH: { type: Types.Number, noedit: true, default: 0  },
		ethAddress: { type: String, label: 'ETH Send Address', noedit:true},
		investedETH: { type: Types.Number, noedit: true, default: 0 },
		ltcAddress: { type: String, label: 'LTC Send Address', noedit:true},
