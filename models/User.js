...
User.add(
	...
	'Investment Details',
	{
		...
		btcAddress: { type: String, label: 'BTC Send Address', noedit:false},
		investedBTC: { type: Types.Number, noedit: true, default: 0  },
		bchAddress: { type: String, label: 'BCH Send Address', noedit:false},
		investedBCH: { type: Types.Number, noedit: true, default: 0  },
		ethAddress: { type: String, label: 'ETH Send Address', noedit:false},
		investedETH: { type: Types.Number, noedit: true, default: 0 },
		ltcAddress: { type: String, label: 'LTC Send Address', noedit:false},
