...
User.add(
	...
	'Investment Details',
	{
		...
		btcAddress: { type: String, label: 'BTC Send Address', noedit:false, unique: true},
		investedBTC: { type: Types.Number, noedit: true, default: 0  },
		bchAddress: { type: String, label: 'BCH Send Address', noedit:false, unique: true},
		investedBCH: { type: Types.Number, noedit: true, default: 0  },
		ethAddress: { type: String, label: 'ETH Send Address', noedit:false, unique: true},
		investedETH: { type: Types.Number, noedit: true, default: 0 },
		ltcAddress: { type: String, label: 'LTC Send Address', noedit:false, unique: true},
